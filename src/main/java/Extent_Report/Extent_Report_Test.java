...
public class Extent_Report_Test{
    ...
    public void startReport(){
        ...
        extent = new ExtentReports (System.getProperty("user.dir") +"/test-output/NTV_Test_Results.html", true);
    ...
    public void passTest(){
        ...
        logger.log(LogStatus.PASS, "Test Case Passed is passTest Mahmut");
    }
    ...
    public void getResult(ITestResult result){
        if(result.getStatus() == ITestResult.FAILURE){
            ...
            logger.log(LogStatus.SKIP, "sercan skip-0 "+result.getName());
        }
        // ending test
